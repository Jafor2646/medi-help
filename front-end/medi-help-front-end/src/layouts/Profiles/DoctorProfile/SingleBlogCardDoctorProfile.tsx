...
export const SingleBlogCardDoctorProfile: React.FC<{blog: BlogViewerModel}> = (props) => {
  ...
  const blogClicked = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
  ...
  return (
      <div className="card shadow text-dark mt-1 m-2  card-hover-style">
        <div className="card-body">
          <a href="#" className="text-center card-link-style" onClick={blogClicked}>{props.blog.blogTitle}</a>
